...
captionFormat:"{0} 선택",// format of caption text. you can set your locale.
captionFormatAllSelected:"{0} 전체 선택",// format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
